...
class FrozenLakeEnvOX2(FrozenLakeEnv):
    metadata = {
    ...
    def __init__(
        ...
        # DFA状态映射
        self.dfa_states = ['@q1', '@q2', '@q3', '@q4', '@q5', '@q6', '@q7', '@q8', '@q9', '@q10', '@q11']
        ...
        self.observation_space = spaces.Dict({
            ...
            "ds": Box(low=0, high=11, shape=(1,), dtype=np.int64),
    ...
    def step(self, a):
        ...
        # dfa step
        props = {'p1': False, 'p2': False, 'p3': False, 'p4': False, 'p5': False}
    ...
    def reset(
        ...
        while not self.start:
            if reset_state is None:
                ...
                break
        info = reset_state
        obs, self.end_states, self.buffer_action, self.value, self.log_prob, _ = info
        self.initial_state = obs
        reset_state, info_ = self.reset_from_state(obs)
        self.lastaction = None
        self.current_step = 0

        if self.render_mode == "human":
            self.render()
        return reset_state, info_
    ...
    def reset_from_state(self, state_dict: Dict[str, Any], seed: Optional[int] = None):
        ...
        for i in range(1, 4):
            ...
            passenger_loc = passenger_loc.squeeze()
