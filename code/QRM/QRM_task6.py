...
if __name__ == '__main__':
    ...
    parser.add_argument('-log', type=str, default='task4_OX_1.csv', help='log path')
    parser.add_argument('-i', type=str, default='inst1', help='inst name')
    parser.add_argument('-r', type=str, default='racecar3', help='inst name')
    parser.add_argument('-c', type=int, default=64, help='process num')
    ...
    agent.learn(total_timesteps=190000)