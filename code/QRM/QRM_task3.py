...
from MySAC_OX8 import MySAC
from HalfCheetahEnv8 import HalfCheetahEnv
from HalfCheetahEnvOX8 import HalfCheetahEnvOX
import signal
import time
import sys
...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', type=int, default=3, help='process num')
