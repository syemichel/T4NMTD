...
from MySAC_OX9 import MySAC
from HalfCheetahEnv9 import HalfCheetahEnv
from HalfCheetahEnvOX9 import HalfCheetahEnvOX
import signal
import time
import sys
...
if __name__ == '__main__':
    ...
    parser.add_argument('-log', type=str, default='task', help='log path')
    ...
    parser.add_argument('-c', type=int, default=7, help='process num')
