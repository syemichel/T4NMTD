...
if __name__ == '__main__':
    ...
    parser.add_argument('-log', type=str, default='task2_OX_5.csv', help='log path')
    parser.add_argument('-i', type=str, default='inst25', help='inst name')
    parser.add_argument('-r', type=str, default='waterworld2', help='inst name')
    parser.add_argument('-c', type=int, default=15, help='process num')
