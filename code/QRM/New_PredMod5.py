...
class PredMod:
    def __init__(self, upper_domain, lower_domain, instance, text, training_time, log_path):
        ...
        lower_env_ = FrozenLakeEnv2(desc=None, map_name="8x8", is_slippery=False, render_mode='human')
        eval_env = maybe_make_env(copy.deepcopy(lower_env_), 1)
        ...
        for _ in range(5):
            ...
            while not done:
                ...
                while not done:
                    ...
                    next_dfa_state == '@q6') +  30 * int(next_dfa_state == '@q7' or next_dfa_state == '@q8' or next_dfa_state == '@q9')
                           + 40 * int(next_dfa_state == '@q10') + 100 * int(next_dfa_state == '@q11')) - (0 * int(dfa_state == '@q1') + 10 * int(
                                dfa_state == '@q3' or dfa_state == '@q4' or dfa_state == '@q5') + 20 * int(
                                dfa_state == '@q6') +  30 * int(dfa_state == '@q7' or dfa_state == '@q8' or dfa_state == '@q9')
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            for u1, v1 in self.dfa.edges():
                ...
                if evaluate_logic_formula(props, formula):
                    r = np.array([(0 * int(next_dfa_state == '@q1') + 10 * int(
                    next_dfa_state == '@q3' or next_dfa_state == '@q4' or next_dfa_state == '@q5') + 20 * int(
                    next_dfa_state == '@q6') +  30 * int(next_dfa_state == '@q7' or next_dfa_state == '@q8' or next_dfa_state == '@q9')
                           + 40 * int(next_dfa_state == '@q10') + 100 * int(next_dfa_state == '@q11')) - (0 * int(dfa_state == '@q1') + 10 * int(
                                dfa_state == '@q3' or dfa_state == '@q4' or dfa_state == '@q5') + 20 * int(
