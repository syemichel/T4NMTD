...
if __name__ == '__main__':
    ...
    parser.add_argument('-log', type=str, default='task2_OX_1.csv', help='log path')
    ...
    parser.add_argument('-c', type=int, default=24, help='process num')
