...
class FrozenLakeEnv1(FrozenLakeEnv):
    ...
    def __init__(
        ...
        self.observation_space = spaces.Dict({
            ...
            "p-p1": Discrete(2), "p-p2": Discrete(2), "p-p3": Discrete(2), "p-p4": Discrete(2)
        })
    ...
    def _get_state_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "p-p1": int(self.props['p1']), "p-p2": int(self.props['p2']), "p-p3": int(self.props['p3']), "p-p4": int(self.props['p4'])
        }
