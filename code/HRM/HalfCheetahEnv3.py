...
else if(ds==@q1 ^ (p4 & ~p2)) then @q3
else if(ds==@q1 ^ (p2 & ~p4)) then @q4
else if(ds==@q1 ^ (p2 & p4)) then @q5
else if(ds==@q3 ^ (~p3 & ~p5)) then @q3
else if(ds==@q3 ^ (p5 & ~p3)) then @q2
else if(ds==@q3 ^ (p3)) then @q6
else if(ds==@q4 ^ (~p1 & ~p3)) then @q4
else if(ds==@q4 ^ (p1 & ~p3)) then @q2
else if(ds==@q4 ^ (p3)) then @q7
else if(ds==@q5 ^ (~p1 & ~p3 & ~p5)) then @q5
else if(ds==@q5 ^ (p1 & ~p3 & ~p5)) then @q3
else if(ds==@q5 ^ (p5 & ~p1 & ~p3)) then @q4
else if(ds==@q5 ^ (p1 & p5 & ~p3)) then @q2
else if(ds==@q5 ^ (p3)) then @q8
else if(ds==@q2 ^ (True)) then @q2
else if(ds==@q6 ^ (~p2 & ~p4)) then @q6
else if(ds==@q6 ^ (p4 & ~p2)) then @q2
else if(ds==@q6 ^ (p2)) then @q9
else if(ds==@q7 ^ (~p2 & ~p4)) then @q7
else if(ds==@q7 ^ (p4)) then @q9
else if(ds==@q7 ^ (p2 & ~p4)) then @q2
else if(ds==@q8 ^ (~p2 & ~p4)) then @q8
else if(ds==@q8 ^ (p2 | p4)) then @q9
else if(ds==@q9 ^ (True)) then @q9'''
...
class HalfCheetahEnv_wo_dfa(MujocoEnv, utils.EzPickle):
    ...
    def step(self, action):
        ...
        if not terminated:
            ...
            reward = 100 / (self.automata_states_num + 1) - 100 / (self.automata_states_num - last_dfa_state)
        elif if_success:
...
class HalfCheetahEnv(gym.ObservationWrapper):
    ...
    def observation(self, obs):
        return {"obs": obs, "ds": int(self.env.get_wrapper_attr('dfa').dfa_state.split('q')[1])-1,
                "p-p1": self.env.get_wrapper_attr('props')['p1'], "p-p2": self.env.get_wrapper_attr('props')['p2']
                , "p-p3": self.env.get_wrapper_attr('props')['p3'], "p-p4": self.env.get_wrapper_attr('props')['p4']
                , "p-p5": self.env.get_wrapper_attr('props')['p5']}
