...
from frozen_lake1 import FrozenLakeEnv1
from frozen_lakeOX1 import FrozenLakeEnvOX1
...
class HDQN:
    def __init__(self, upper_domain, lower_domain, instance, text, training_time, log_path):
        ...
        upper_env = UpperRMEnv(FrozenLakeEnv1(desc=None, map_name="8x8", is_slippery=False))
        ...
        lower_env = FrozenLakeEnvOX1(desc=None, map_name="8x8", is_slippery=False)
...
if __name__ == '__main__':
    ...
    text_path = 'dfa_text/frozenlake/frozenlake1.txt'
