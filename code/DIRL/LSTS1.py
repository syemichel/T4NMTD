...
class PredMod:
    def __init__(self, upper_domain, lower_domain, instance, text, training_time, log_path):
        ...
        lower_env = FrozenLakeEnv1(desc=None, map_name="8x8", is_slippery=False)
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            # reward shaping
            if next_dfa_state != dfa_state and next_dfa_state == v:
                rewards = (0 * int(next_dfa_state == '@q1') + 10 * int(
                    ...
                    dfa_state == '@q3' or dfa_state == '@q4' or dfa_state == '@q5') - 100 * int(
                    dfa_state == '@q6'))
