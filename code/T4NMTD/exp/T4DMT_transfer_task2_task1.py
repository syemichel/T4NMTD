...
from model.LowerModel import LowerSAC, LoadLowerSAC
    ...
    def run(self):
        ...
        for i in range(self.option_num):
            ...
            if os.path.exists(file_path):
                lower_learners[i] = ray.remote(num_cpus=2.25)(LoadLowerSAC).remote(
                ...
                lower_learners[i] = ray.remote(num_cpus=2.25)(LowerSAC).remote(
                    policy="MultiInputPolicy",
                           env=lower_envs[i],
                           actor_ps=actor_ps,
                           critic_ps=critic_ps,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-log', type=str, default='log/task4/task_transfer5.csv', help='log path')
    parser.add_argument('-i', type=str, default='inst32', help='inst name')
    ...
    text_path = text_path['waterworld5']
