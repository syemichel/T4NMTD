...
from model.LowerModel import LowerSAC
from stable_baselines3 import SAC, PPO
from server.ParameterServer import *
from UpperModel_random import DFAPathFinder
...
class T4DMT:
    ...
    def run(self):
        ...
        for u, v in self.dfa.edges():
            self.dfa[u][v]['random'] = copy.deepcopy(random.choice(["p1", "p2", "p3", "p4"]))
        ...
        learn.save(log_path + '/model0')'''

        lower_learners = [ray.remote(num_cpus=3)(LowerSAC) for _ in range(self.option_num)]
        lower_learners = [
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', type=int, default=1000, help='training time')
