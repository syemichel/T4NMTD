...
class T4DMT:
    ...
    def run(self):
        ...
        reset_ps = ray.remote(num_cpus=0.5)(ResetStatesServer_random)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-log', type=str, default='log1/task1/task3.csv', help='log path')
