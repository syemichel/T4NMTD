...
class MiniGridEnv1(MiniGridEnv):
    """
    ## Description
    ...
    def __init__(self,
            ...
            max_steps: int = 200,
            **kwargs):
        self.agent_start_pos = agent_start_pos  # agent的起始位置
        self.agent_start_dir = agent_start_dir  # agent的起始朝向
        self.Ball1_pos = (5, 10)
        self.Ball2_pos = (13, 1)
        self.Ball3_pos = (13, 8)
        self.task = None
...
if __name__ == '__main__':
    env = MiniGridEnv1(render_mode="human")
    s, _ = env.reset()
