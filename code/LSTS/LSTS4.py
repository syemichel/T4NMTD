...
class PredMod:
    ...
    def policy_advance(self, goal_dfa_state):
        ...
        for edge in edge_path:
            ...
            while dfa_state != v or length == 1500:
                action, _ = self.lower_model.predict_eval(self.lower_model._last_obs, u, v, deterministic=False)
    ...
    def select_convergence(self, last_average_rewards, average_rewards):
        ...
        return success_rate > 0.7 and abs(average_rewards - last_average_rewards) < 1
    ...
    def evaluate(self, seconds):
        ...
        while not done:
            ...
            u, v = task
            while not done:
                action, _ = self.lower_model.dfa[u][v]['policy'].predict(obs, u, v, deterministic=True)
